 ...
 */
void
abd_checksum_blake3_native(abd_t *abd, uint64_t size, void* data, const void *ctx_template,
    zio_cksum_t *zcp)
{
	(void) data;
 ...
 */
void
abd_checksum_blake3_byteswap(abd_t *abd, uint64_t size, void* data,
    const void *ctx_template, zio_cksum_t *zcp)
{
	...
	abd_checksum_blake3_native(abd, size, data, ctx_template, &tmp);
