...
__attribute__((unused))  int record_exists(const C_map_node_t* node, const cksum_seqno* key) {
...
__attribute__((unused))  void* get_serialized_hash(C_map_t *map, const cksum_seqno* key) {
